...
private:
	...
	void RenderSlice(string FileName, int RendGroup, float PixelSize, cudaStream_t cstream);
	...
	void ImageRender(float *h_LocArry, float *d_LocArry, float *d_SRIntensityImg,  float PixelSize, float PixelZoom, int SRImageWidth, int SRImageHigh, int FluoNum, cudaStream_t cstream);
...
__global__ void PointFillRegionWithPrec1(float *d_LocArry, float *d_SRIntensityImg,  float PixelSize, float PixelZoom, int SRImageWidth, int SRImageHigh, int FluoNum);
